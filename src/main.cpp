/*
 ...
 Uses compile time to set the time so a reset will start with the compile time
 again
...
// Code to run a screen calibration, not needed when calibration values set in
// setup()
...
void setup(void) {
    ...
    tft.setTextColor(TFT_GREEN,
                     TFT_GREY);  // Adding a black background colour erases
